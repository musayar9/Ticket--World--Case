        ...
        <div className="p-2 max-2xl:w-[50%] max-xl:w-[60%] max-lg:w-[70%] max-md:w-[90%] max-sm:w-[100%] m-auto mt-24 flex flex-col items-center">
          ...
          <div className="w-[100%] flex text-gray-800 justify-between items-center p-2 border border-gray-700 rounded-lg shadow">
            ...
            <Link to="/payment">
              <button
                type="button"
                className={`text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center dark:bg-green-600 dark:hover:bg-green-700 ${
                  cartList?.length !== 0 ? "opacity-100" : "opacity-50"
                }`}
