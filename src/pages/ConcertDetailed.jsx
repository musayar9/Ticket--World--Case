        ...
        <div className="my-20" style={{ border: "1px solid red" }}>
            ...
            <div className="container mx-auto mt-8 flex">
                <div className="w-2/3 pr-8">
                    <img src="https://ichef.bbci.co.uk/images/ic/1200x675/p0fq9cyz.jpg" alt="Konser Resmi" className="w-full h-96 object-cover rounded-lg shadow-2xl" />
                </div>

                <div className="w-1/3 p-8 bg-white rounded-lg shadow-lg">
                    <div className="mb-4">
                        <span className="text-gray-600 font-semibold">Kategori:</span> Category Name
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        <span className="text-gray-600 font-semibold">Açıklama:</span> Description
                    </div>
                    <div className="mb-4">
                        <span className="text-gray-600 font-semibold">Yer:</span> Location
                    </div>
                    <div className="mb-4">
                        <span className="text-gray-600 font-semibold">Yer Adı:</span> Location Name
                    </div>
                    <div className="mb-4">
                        <span className="text-gray-600 font-semibold">Bilet Fiyatı:</span> Ticket Price
                    </div>
                    <div className="mb-4">
            ...
            <div className="text-center">
                <a href="#" className="bg-red-800 text-white py-3 px-6 rounded-full inline-block text-lg font-semibold transition duration-300 hover:bg-purple-600">Add to favorites</a>
                <a href="#" className="bg-purple-800 text-white py-3 px-6 rounded-full inline-block text-lg font-semibold transition duration-300 hover:bg-purple-600">Add to chart</a>
            </div>
