...
export default function SeatsModal() {
    ...
    return (
        <>
            <button onClick={() => setIsOpenModal(prev => !prev)} data-modal-target="default-modal" data-modal-toggle="default-modal" className="block text-white bg-blue-700 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center " type="button">
             Select Armchair
            </button>
