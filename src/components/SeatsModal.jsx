...
export default function SeatsModal() {
    ...
    return (
        <>
            ...
            <div id="default-modal" tabIndex="-1" aria-hidden="true" className={`fixed top-0 left-0 right-0 z-50 ${isOpenModal ? `block` : `hidden`}  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
