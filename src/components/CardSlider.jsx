            ...
            <div id="controls-carousel" className="relative w-[50%] mt-8 mb-4" data-carousel="static">
                {
                    concertData?.image.map((item, index) => (
                        <>
                            <div id={`img-${index + 1}`} className={`object-cover bg-red-800 duration-700 ease-in-out transform translate-x-${index - activeIndex} -translate-y-1/2 ${activeIndex === index ? "opacity-100" : "opacity-0"}`} data-carousel-item>
